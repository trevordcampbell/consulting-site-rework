...
import { AdjustmentsHorizontalIcon, BuildingLibraryIcon, ChatBubbleLeftRightIcon, CircleStackIcon, CloudArrowUpIcon, CubeTransparentIcon, DocumentIcon, DocumentTextIcon, ForwardIcon, LockClosedIcon, PhoneArrowUpRightIcon, ServerIcon, ShieldExclamationIcon, TagIcon } from '@heroicons/react/20/solid'
