...
export const caseStudy = {
  client: 'Unseal',
  title: 'Proactive Patient Risk Forecasting',
  description:
    'Crafted a sophisticated risk prediction model by integrating EHR system data with patient logs. Our model empowers providers with proactive alerts regarding patient needs, markedly enhancing care outcomes and minimizing insurance costs.',
  summary: [
    'Crafted a sophisticated risk prediction model by integrating EHR system data with patient logs. Our model empowers providers with proactive alerts regarding patient needs, markedly enhancing care outcomes and minimizing insurance costs.',
  ],
  logo,
  ...
  testimonial: {
    ...
    content:
      'Prodify did an amazing job building out our core blockchain infrastructure and I’m sure once PlaceboCoin rallies they’ll be able to finish the project.',
  },
}
...
>
  Prodify did an amazing job building out our core blockchain infrastructure and
