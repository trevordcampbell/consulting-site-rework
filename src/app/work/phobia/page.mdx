...
export const caseStudy = {
  ...
  description:
    'By automating support ticket creation and facilitating succinct call summarization, we significantly enhanced call center efficiency. The resulting operational cost reduction was a testament to the efficacy of our solutions.',
  summary: [
    'By automating support ticket creation and facilitating succinct call summarization, we significantly enhanced call center efficiency. The resulting operational cost reduction was a testament to the efficacy of our solutions.',
  ],
  logo,
...
>
  The team at Prodify went above and beyond with our onboarding, even finding a
