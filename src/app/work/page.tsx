...
import { Testimonial } from '@/components/content-pages/Testimonial'
  ...
  return (
    <>
      ...
      <main className="pb-24 sm:pb-32 lg:pb-40">
        ...
        >
          We approached <em>Prodify</em> because we loved their past work. They
          delivered something remarkable in record time.
        </Testimonial>

        <Clients className="my-24 sm:my-32 lg:my-40" />
