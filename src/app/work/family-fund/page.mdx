...
export const caseStudy = {
  ...
  description:
    'Revolutionized the staffing process by automating critical tasks, thereby achieving a seamless match between resumes and employer requirements. Our lead vetting system further streamlined operations, culminating in significant staff cost reductions.',
  summary: [
    'Revolutionized the staffing process by automating critical tasks, thereby achieving a seamless match between resumes and employer requirements. Our lead vetting system further streamlined operations, culminating in significant staff cost reductions.',
  ],
  logo,
...
>
  Working with Prodify, we felt more like a partner than a customer. They really
